...
Git:
    ...
    git clone https://github.com/cucumber/cucumber-java-features.git
    cd cucumber-java-features

Subversion:

    svn checkout https://github.com/cucumber/cucumber-java-features
    cd cucumber-java-features

Or simply [download](https://github.com/cucumber/cucumber-java-features/releases) the latest
...
Specify a particular scenario by *line* (and use the pretty plugin, which prints the scenario back)
    ...
    -Dcucumber.options="classpath:features/belly.feature:4 --plugin pretty"

This works because Maven puts `./src/test/resources` on your `classpath`.
You can also specify files to run by filesystem path:

    -Dcucumber.options="src/test/resources/features/belly.feature:4 --plugin pretty"
